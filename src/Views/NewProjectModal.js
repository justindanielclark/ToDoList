...
const modalContainer = document.createElement('div');
  modalContainer.id = 'newProjectModal';
  modalContainer.className = 'flex flex-col rounded-md shadow-md shadow-slate-600 w-80';
...
modalContainer.append(modalTitle, nameInputGroup, colorInputGroup, iconInputGroup, controlsInputGroup);
